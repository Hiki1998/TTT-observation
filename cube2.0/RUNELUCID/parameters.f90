module parameters
  ...
  ! output directory
  character(*),parameter :: opath='/mnt/18T/cube/usr_out/mingjiesheng/ELUCID_ratio2_PP/'
  ...
  real,parameter :: box=500
  integer,parameter :: ncore=32
  integer,parameter :: nteam=8
  integer,parameter :: nnest=2
  integer(8),parameter :: ng=500

  integer,parameter :: ratio_cs=2
...
# endif
  ...
  integer(8),parameter :: ncb=ngb/ratio_cs ! nc in buffer /dim, single side; ceiling(ncb/ratio_cs)
  ...
  real,parameter :: s8=0.807332993 ! use -Dsigma_8 in initial_conditions
  integer,parameter :: zdim=2 ! the dimension being the redshift direction

  ! background parameters
  real, parameter :: h0=0.72

  real,parameter :: omega_cdm=0.214
  real,parameter :: omega_bar=0.044
