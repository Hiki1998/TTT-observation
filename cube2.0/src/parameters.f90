module parameters
  ...
  ! output directory
  character(*),parameter :: opath='/mnt/18T/cube/usr_out/mingjiesheng/1000_128/'
...
# endif
  ...
  real,parameter :: omega_cdm=0.2327
  real,parameter :: omega_bar=0.0463
